...
export const CONFIG = {
  ...
  FETCH_MAX_RETRIES: parseInt(process.env.FETCH_MAX_RETRIES || "10", 10), // 10 retries
  FETCH_RETRY_DELAY_MS: parseInt(process.env.FETCH_RETRY_DELAY_MS || "5000", 10), // 5s initial delay
  FETCH_TIMEOUT_MS: parseInt(process.env.FETCH_TIMEOUT_MS || "15000", 10), // 15s per fetch attempt
